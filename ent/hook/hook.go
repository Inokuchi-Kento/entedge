...
// The BugFunc type is an adapter to allow the use of ordinary
// function as Bug mutator.
type BugFunc func(context.Context, *ent.BugMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f BugFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.BugMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.BugMutation", m)
}
